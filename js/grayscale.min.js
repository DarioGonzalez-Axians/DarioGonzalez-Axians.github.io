...
! function(e) {
    ...
    }), e(".js-scroll-trigger").click(function() { e(".navbar-collapse").collapse("hide") }), e("body").scrollspy({ target: "#mainNav", offset: 100 });

    function a() {
        if (100 < e("#mainNav").offset().top) {
            e("#mainNav").addClass("navbar-shrink")
            if (window.innerWidth > 991) {
                e("#mainNav a").removeClass("hide")
            }
        } else {
            e("#mainNav").removeClass("navbar-shrink")
            if (window.innerWidth > 991) {
                e("#mainNav a").addClass("hide")
            }
        }
    }
    a(), e(window).scroll(a)
